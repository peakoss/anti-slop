...
| [`max-daily-forks`](#max-daily-forks)                                         | Maximum number of forked repositories by the user in any 24-hour window. 0 disables this check.                                                                                                                                                      | `6`                                                                                          |
| [`require-public-profile`](#require-public-profile)                           | Require the PR author to have a public GitHub profile.                                                                                                                                                                                               | `true`                                                                                       |
| [`min-profile-completeness`](#min-profile-completeness)                       | Minimum number of profile signals (out of 10) the user must have to pass. Checks name, company, blog, location, email, hireable, bio, twitter, followers and following. 0 disables this check.                                                       | `4`                                                                                          |
